...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 28, 2015 at 04:42 PM
...
(16, '', 26, 'Umum', '2015-12-28 16:42:46', '', NULL, 150000, 15000, NULL);
...
--
ALTER TABLE `tbl_prj`
 ADD PRIMARY KEY (`no_rj`), ADD KEY `id_pasien` (`id_pasien`);
...
--
ALTER TABLE `tbl_pasien`
MODIFY `id_pasien` int(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=27;
--
-- AUTO_INCREMENT for table `tbl_pri`
--
ALTER TABLE `tbl_pri`
MODIFY `no_ri` int(8) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_prj`
--
ALTER TABLE `tbl_prj`
MODIFY `no_rj` int(8) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
